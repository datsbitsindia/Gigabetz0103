...
exports.StatusContoller = void 0;
...
let StatusContoller = class StatusContoller {
    postChangeStatus(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { userid, password, betActive, userActive } = req.body;
            const [error, result] = yield asyncWrap_1.asyncWrap(db_1.runSP("U_UserActiveAandBetStatus", [
                {
                    name: "UserID",
                    value: +userid,
                },
...
], StatusContoller.prototype, "postChangeStatus", null);
StatusContoller = __decorate([
    core_1.Controller("change-status")
], StatusContoller);
exports.StatusContoller = StatusContoller;
//# sourceMappingURL=statusContoller.js.map