...
let MasterController = class MasterController {
    getUserDetails(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [error, result] = yield asyncWrap_1.asyncWrap(db_1.runSP("G_UsersSportsAccess", [
                {
                    name: "UserID",
                    value: userid,
                },
    ...
    postChangeGames(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { amount, userid, password, remark } = req.body;
            const [error, result] = yield asyncWrap_1.asyncWrap(db_1.runSP("U_UserSportsAccess", [
                {
                    name: "DepositID",
                    value: 0,
                },
...
], MasterController.prototype, "getUserDetails", null);
__decorate([
    core_1.Post(""),
    core_1.Middleware(CustomRole_1.auth_role(CustomRole_1.ROLES["Super Admin"]))
], MasterController.prototype, "postChangeGames", null);
MasterController = __decorate([
    core_1.Controller("change-game")
], MasterController);
