...
let PasswordController = class PasswordController {
    postChangePassword(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [error, result] = yield asyncWrap_1.asyncWrap(db_1.runSP("U_UserPassword", [
                {
                    name: "UserID",
                    value: +userid,
                },
...
], PasswordController.prototype, "postChangePassword", null);
PasswordController = __decorate([
    core_1.Controller("change-password")
], PasswordController);
exports.PasswordController = PasswordController;
//# sourceMappingURL=passwordContoller.js.map