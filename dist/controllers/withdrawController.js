...
let WithdrawController = class WithdrawController {
    postWithdraw(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [error, result] = yield asyncWrap_1.asyncWrap(db_1.runSP("I_UserWithdrawRequestBySuperuser", [
                {
                    name: "WithdrawID",
                    value: 0,
                },
...
], WithdrawController.prototype, "postWithdraw", null);
WithdrawController = __decorate([
    core_1.Controller("withdraw")
], WithdrawController);
