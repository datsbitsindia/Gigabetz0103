...
let ProxyController = class ProxyController {
    postLimit(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [error, result] = yield asyncWrap_1.asyncWrap(axios_1.default.get(`${api_service_url}?token=${token}&sport_id=${sports_id}`));
            if (!result) {
...
__decorate([
    core_1.Get("")
], ProxyController.prototype, "postLimit", null);
ProxyController = __decorate([
    core_1.Controller("api/sports")
], ProxyController);
