...
let OddsController = class OddsController {
    postOdds(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [error, result] = yield asyncWrap_1.asyncWrap(db_1.runSP("IU_UserMinMaxOdds", [
                {
                    name: "MinimumOdds",
                    value: minOdds,
                },
...
], OddsController.prototype, "postOdds", null);
OddsController = __decorate([
    core_1.Controller("odds")
], OddsController);
